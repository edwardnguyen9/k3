gods = {
    ...
    'kvothe': ['The cthae has gathered {number} scrael. They drop money upon being killed.', 'The warrior with the most kills will get a legendary crate!', 606386904157388800],
...
hp = 'This boss has {hp} HP.'
cash = 'The total payout is ${cash}.'
