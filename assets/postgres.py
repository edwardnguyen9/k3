queries = {
    ...
    'fetch_all_users':  'SELECT * FROM profile3;',
    ...
    'delete_profile':   'DELETE FROM profile WHERE wt < $1;',
    # Favorite
    ...
    'all_fav':      'SELECT * FROM protected',
    'delete_fav':   'DELETE FROM protected WHERE uid=$1',
    # Activity
